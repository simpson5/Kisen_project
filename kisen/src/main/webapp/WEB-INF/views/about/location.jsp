...
<div id="wrap">
	<div class="container mx-auto">
	        ...
	        <div class="col-xs-12 mx-auto" style="width:100%;">
	        	<div class="pd-detail-menu" style="width:100%;">
					<div class="row text-center">
						...
						<div class="col-md-2 pd-nav" id="nav1" >회사소개</div>
						<div class="col-md-4 select pd-nav" id="nav2">오프라인매장안내</div>
						<div class="col-md-3 border border-top-0 border-left-0 border-right-0"></div>
					</div>
				</div>
	        </div>
	    ...
	    <div class="row map mx-auto" style="text-align: center; vertical-align:middle; width:100%;">
	    	<div class="col-xs-6 ml-auto">
	    		<div id="map" style="width:500px; height : 300px; margin:0 auto; text-align:center;"></div>
